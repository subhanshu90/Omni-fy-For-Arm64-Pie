...
print_modname() {
  ...
  ui_print "************************************"
  ui_print "    Omni-fy For Pie (Arm64 only)     "
  ui_print "                By Stark1296                      "
  ui_print "************************************"
  unity_main # Don't change this line
}

set_permissions() {
  set_perm $UNITY/system/etc/permissions/omni-power-whitelist.xml 0 0 0755
  set_perm $UNITY/system/etc/permissions/privapp-permissions-omni.xml 0 0 0755
  set_perm $UNITY/system/etc/permissions/privapp-permissions-omni-log.xml 0 0 0755
